...
export const fetchData = async (): Promise<ResponseData> => {
  const response: AxiosResponse<ResponseData> = await axios.get(`https://beta.ruralindiaonline.org/api/api/childrens-paintings?populate=Painting,ChildPhoto&sort=Title`, { headers });
